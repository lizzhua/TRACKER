...
EVENT_PROMPT_TEMPLATE = """你是一位品牌活動情報分析專家。請分析以下關於 aespa品牌的內容，判斷是否包含品牌活動或重要事件。
...
## 回應格式（必須回傳純 JSON）
{{"has_event": true, "event_type": "promotion", "event_detail": "Gemini全館 85 折", "event_date": "2025-05-01"}}
...
if __name__ == "__main__":
    ...
    test_item = CollectedItem(
        title="aespa 世巡演唱會台北站搶票全攻略！",
        snippet="aespa 終於要來台北開唱啦！官方稍早公佈了最新的世巡演唱會場次，台北站預計在下個月於林口體育館舉辦，粉絲千萬別錯過！",
        url="https://example.com/aespa-tour-taipei",
        language="zh",
        keyword="aespa 演唱會",
    )
