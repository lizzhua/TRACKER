...
SENTIMENT_PROMPT_TEMPLATE = """你是一位品牌輿情分析專家。請分析以下關於 AVEDA（肯夢）品牌的內容，判斷其情緒傾向。
...
## 分析要求
1. 判斷這段內容對 AVEDA 品牌的情緒是「正面 (positive)」、「負面 (negative)」或「中立 (neutral)」。
...
if __name__ == "__main__":
    ...
    test_item = CollectedItem(
        title="AVEDA 全新蘊活菁華升級版上市",
        snippet="AVEDA 推出全新升級版 Invati 蘊活菁華，添加更多植物萃取成分，有效減少掉髮。",
        url="https://example.com/aveda-invati",
        source="Beauty News",
        language="zh",
        keyword="AVEDA 蘊活菁華",
    )
